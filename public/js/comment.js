...
function formatDate(d) {
    ...
    var months = date1.getMonth() + 1 < 10 ? '0' + (date1.getMonth() + 1) : date1.getMonth() + 1;
    var dates = date1.getDate() < 10 ? '0' + date1.getDate() : date1.getDate();
    ...
    return date1.getFullYear() + '年' + months + '月' + dates + '日 ' + date1.getHours() + ':' + minutes + ':' + seconds;
}